...
def process_inputs(inputs):
	...
	df = df3.select_dtypes(include=['number'])

	# Handling outliers using IQR method
	Q1 = df.quantile(0.25)
	Q3 = df.quantile(0.75)
	IQR = Q3 - Q1
	df3 = df3[~((df < (Q1 - 1.5 * IQR)) | (df > (Q3 + 1.5 * IQR))).any(axis=1)]
...
input_values = ['2012-01-01', '0.0', '12.8', '5.0', '4.7']

# Call the function
result = process_inputs(input_values)
